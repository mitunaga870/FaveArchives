...
module.exports = async (songid) =>{
    let q = 'select songs.videoid,songs.timestump,songs.endtime,videodetail.private from songs join videodetail on songs.videoid = videodetail.videoid where videodetail.private!=-1 and songs.songid=\''+songid+'\'';
